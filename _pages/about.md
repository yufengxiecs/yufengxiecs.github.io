...
<div class="pubs-item">
  ...
  <div class='paper-box-image' style='-webkit-filter: drop-shadow(10px 10px 10px rgba(0,0,0,.5)); 
                filter: drop-shadow(10px 10px 10px rgba(0,0,0,.5)); margin-top: 5px;'><div><div class="badge">Under Review</div><img src='/images/CAMEL.png' alt="sym" width="400"></div></div>
  <br>
    </div>
  </div>
...
## Contact with me
Welcome to contact with me via email [yufengxie.cs@gmail.com](mailto:yufengxie.cs@gmail.com).
